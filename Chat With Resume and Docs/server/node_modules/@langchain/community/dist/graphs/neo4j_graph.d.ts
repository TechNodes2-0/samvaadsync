...
export declare class Neo4jGraph {
    ...
    query<RecordShape extends Record<string, any> = Record<string, any>>(query: string, params?: Record<string, any>, routing?: RoutingControl): Promise<RecordShape[] | undefined>;
