    ...
    <section className="text-gray-400 dark:bg-gray-800 body-font">
      <div className="container flex flex-wrap px-5 py-24 mx-auto">
        <div className="flex flex-col w-full mb-20 text-center">
          ...
          <h1 className="text-2xl font-medium sm:text-3xl title-font text-blue-800 ">
            About
          </h1>
        </div>
        <div className="flex flex-wrap -m-4">
          <div className="p-4 md:w-1/3">
            <div className="flex flex-col h-full p-8 bg-gray-200 shadow-lg rounded-lg bg-opacity-60">
